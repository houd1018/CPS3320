...
# architecture of VGG-16's convolutional part
cfgs = {
...
def VGG16(pretrained, in_channels, **kwargs):
    ...
    if pretrained:
        state_dict = load_state_dict_from_url("https://download.pytorch.org/models/vgg16-397923af.pth", model_dir="./pre-trianedModel")
